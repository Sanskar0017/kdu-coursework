...
function likeButton() {
  ...
  var likePost = document.getElementById("like-post");
...
function postLikeButton() {
  var likePost = document.getElementById("icons-like");
  if (likePost && inputPostValue.length > 0) {
    likePost.style.fill = likePost.style.fill == "grey" ? "red" : "grey";
  }
}
...
function menu() {
  //    mobDisplay[0].style.display == "flex" ? "flex" : "none";
...
function postMobile() {
  ...
  var postScreenMob = document.querySelector(".post-screen-mob");
