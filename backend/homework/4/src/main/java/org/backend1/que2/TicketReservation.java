...
public class TicketReservation {
    ...
    public boolean cancel(String confirmationNumber) {
        // check through the array list first
        ...
        while(it.hasNext()){
            if(removePassenger(it, confirmationNumber)){
                ...
                // first passenger from waiting list is switch to confirmed list
                // poll method is used to remove from the deque
                Passenger wlfirst = waitingList.poll();

                // return null if the deque is empty
                if(wlfirst != null){
                    confirmedList.add(wlfirst);
                }
        ...
        // check through the waiting list
    ...
    public boolean removePassenger(Iterator<Passenger> iterator, String confirmationNumber) {
        if(iterator instanceof ArrayList){
